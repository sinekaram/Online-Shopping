...
<input class="input-style" type="text" name="description" value="<%=rs.getString(6)%>" required>
 
<hr>
</div>
<div class="right-div">
<h3>Enter Count</h3>
<input class="input-style" type="number" name="count" value="<%=rs.getInt(7)%>" required>
